...
0
|| checktplrefresh('./template/dean_delight/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1477893844, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/dean_delight', 'forum/forumdisplay')
|| checktplrefresh('./template/dean_delight/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1477893844, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/dean_delight', 'forum/forumdisplay')
|| checktplrefresh('./template/dean_delight/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1477893844, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/dean_delight', 'forum/forumdisplay')
|| checktplrefresh('./template/dean_delight/forum/forumdisplay.htm', './template/dean_delight/forum/forumdisplay_list.htm', 1477893844, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/dean_delight', 'forum/forumdisplay')
|| checktplrefresh('./template/dean_delight/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1477893844, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/dean_delight', 'forum/forumdisplay')
|| checktplrefresh('./template/dean_delight/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1477893844, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/dean_delight', 'forum/forumdisplay')
|| checktplrefresh('./template/dean_delight/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1477893844, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/dean_delight', 'forum/forumdisplay')
...
<div class="deanside" >
        	<div class="deanforumjs">
                ...
                <div class="deanjsbottom">
                	<ul>
                    	<li><span>今日</span><div class="clear"></div><em><?php echo $_G['forum']['todayposts'];?></em></li>
                        <li><span>主题</span><div class="clear"></div><em><?php echo $_G['forum']['threads'];?></em></li>
                        <div class="clear"></div>
                    </ul>
                </div>
            </div>
            <div class="clear"></div>
        	<div class="deansideforum">
            	<ul><!--[diy=deansideforum]--><div id="deansideforum" class="area"></div><!--[/diy]--></ul>
                <div class="clear"></div>
                <script type="text/javascript">
                	jq(".deansideforum ul li:last").css("padding","0")
jq(".deansideforum ul li:last").css("border","0")
                </script>
            </div>
            <div class="clear"></div>

            <div class="deantype">
            	<div class="deantypetop"></div>
                <div class="deantypecx">
                	<div class="deantypetitle"><h3><span></span><em><strong>热门</strong>分类</em><div class="clear"></div></h3></div>
                    <div class="clear"></div>
                	<div class="deantypec"><!--[diy=deantypec]--><div id="deantypec" class="area"></div><!--[/diy]--><div class="clear"></div></div>
                </div>
            </div>
            <div class="clear"></div>
            <div class="deanhotpic">
            	<h3><span></span><em><strong>版主</strong>推荐</em><div class="clear"></div></h3>
                <div class="clear"></div>
                <ul><!--[diy=deanhotpic]--><div id="deanhotpic" class="area"></div><!--[/diy]--></ul>
            </div>
            <script type="text/javascript">
...
<div class="mn deanmn">
        	<div class="deantj">
            	<div class="deantjicon"></div>
            	<ul><!--[diy=deantj]--><div id="deantj" class="area"></div><!--[/diy]--></ul>
                <dl><!--[diy=deantj1]--><div id="deantj1" class="area"></div><!--[/diy]--></dl>
                <div class="clear"></div>
            </div>
...
<?php } if($moderatedby) { ?><div>版主: <span class="xi2"><?php echo $moderatedby;?></span></div><?php } ?>
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;orderby=<?php echo $_GET['orderby'];?>&amp;ffilter=dateline&amp;dateline=2592000<?php echo $forumdisplayadd['dateline'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" <?php if($_GET['dateline'] == '2592000') { ?>class="xw1"<?php } ?>>一个月</a><span class="pipe">|</span>
