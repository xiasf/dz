...
0
|| checktplrefresh('data/diy/./template/dean_delight//portal/view_1.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1477894990, 'diy', './data/template/2_diy_portal_view_1.tpl.php', 'data/diy/./template/dean_delight/', 'portal/view_1')
|| checktplrefresh('data/diy/./template/dean_delight//portal/view_1.htm', './template/default/common/seccheck.htm', 1477894990, 'diy', './data/template/2_diy_portal_view_1.tpl.php', 'data/diy/./template/dean_delight/', 'portal/view_1')
;
block_get('455,456,457,458,459,460,461,462,463');?><?php include template('common/header'); ?><script src="<?php echo $_G['setting']['jspath'];?>forum_viewthread.js?<?php echo VERHASH;?>" type="text/javascript"></script>
...
<div class="clear"></div>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><style id="diy_style" type="text/css">#portal_block_456 { margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_458 { margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_460 { margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_463 { margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}</style>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framexcj2Zw" class="cl_frame_bm frame move-span cl frame-1"><div id="framexcj2Zw_left" class="column frame-1-c"><div id="framexcj2Zw_left_temp" class="move-span temp"></div><?php block_display('455');?><?php block_display('456');?><?php block_display('457');?><?php block_display('458');?><?php block_display('459');?><?php block_display('460');?><?php block_display('461');?><?php block_display('462');?></div></div><div id="frameAwE8xn" class="cl_frame_bm frame move-span cl frame-1"><div id="frameAwE8xn_left" class="column frame-1-c"><div id="frameAwE8xn_left_temp" class="move-span temp"></div><?php block_display('463');?></div></div></div><!--[/diy]-->
</div>
<div id="ct" class="ct2 wp cl">
<div class="mn">
<div class="bm vw">
        	<div class="deanp_onertitle1">
                    <h4>内容&nbsp;&middot;<span>详情</span></h4>
                </div>
<div class="h hm">
...
<?php if($article['summary'] && empty($cat['notshowarticlesummay'])) { ?><div class="s" style="border-bottom:0;"><div style="padding:10px;"><strong></strong> <?php echo $article['summary'];?></div><?php if(!empty($_G['setting']['pluginhooks']['view_article_summary'])) echo $_G['setting']['pluginhooks']['view_article_summary'];?></div><?php } ?>
...
<div class="sd pph">
 <?php if($cat['others']) { ?>
            <div class="deanlink bgfff ">
                 <div class="deanp_onertitle1">
                    <h4>网站&nbsp;&middot;<span>相关分类</span></h4>
                </div>
