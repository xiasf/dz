...
block_get('219,220,221,222');?><?php include template('common/header'); ?><div id="pt" class="bm cl">
...
<script src="<?php echo $_G['style']['styleimgdir'];?>/froumslide.js" type="text/javascript"></script>
<div class="deandzwp">
<div class="deandzwpbox">
        <div class="deandzwpl"><!--[diy=deandzwpl]--><div id="deandzwpl" class="area"><div id="frameUQ9h9m" class="cl_frame_bm frame move-span cl frame-1"><div id="frameUQ9h9m_left" class="column frame-1-c"><div id="frameUQ9h9m_left_temp" class="move-span temp"></div><?php block_display('219');?></div></div></div><!--[/diy]--></div>
        <div class="deandzwpr">
        	<div class="deandztab">
                ...
                <div class="clear"></div>
                <ul class="deandztabc">
                	<li style="display:block;"><dl><!--[diy=deandztabc]--><div id="deandztabc" class="area"><div id="frameMbb24G" class="cl_frame_bm frame move-span cl frame-1"><div id="frameMbb24G_left" class="column frame-1-c"><div id="frameMbb24G_left_temp" class="move-span temp"></div><?php block_display('220');?></div></div></div><!--[/diy]--></dl></li>
                    <li><dl><!--[diy=deandztabc1]--><div id="deandztabc1" class="area"><div id="frameUZgvBj" class="cl_frame_bm frame move-span cl frame-1"><div id="frameUZgvBj_left" class="column frame-1-c"><div id="frameUZgvBj_left_temp" class="move-span temp"></div><?php block_display('221');?></div></div></div><!--[/diy]--></dl></li>
                    <li><dl><!--[diy=deandztabc2]--><div id="deandztabc2" class="area"><div id="framet2QJtp" class="cl_frame_bm frame move-span cl frame-1"><div id="framet2QJtp_left" class="column frame-1-c"><div id="framet2QJtp_left_temp" class="move-span temp"></div><?php block_display('222');?></div></div></div><!--[/diy]--></dl></li>
                </ul>
...
<div class="fl bm">
<?php if(!empty($collectiondata['follows'])) { $forumscount = count($collectiondata['follows']);?><?php $forumcolumns = 4;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="bm bmw <?php if($forumcolumns) { ?> flg<?php } ?> cl deanbmw">
<div class="bm_h cl">
<span class="o">
...
<?php } if(empty($gid) && !empty($forum_favlist)) { $forumscount = count($forum_favlist);?><?php $forumcolumns = $forumscount > 3 ? ($forumscount == 4 ? 4 : 5) : 1;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="bm bmw  deanbmw <?php if($forumcolumns) { ?> flg<?php } ?> cl">
<div class="bm_h cl">
<span class="o">
...
<div class="bm bmw  deanbmw <?php if($cat['forumcolumns']) { ?> flg<?php } ?> cl">
<div class="bm_h cl">
<span class="o">
...
</div><?php echo adshow("intercat/bm a_c/$cat[fid]");?><?php } if(!empty($collectiondata['data'])) { $forumscount = count($collectiondata['data']);?><?php $forumcolumns = 4;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="bm bmw <?php if($forumcolumns) { ?> flg<?php } ?> cl deanbmw">
<div class="bm_h cl">
<span class="o">
