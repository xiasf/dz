...
<div id="ft" style="padding:0; border:0;">
    	...
    	<div class="w1180" style="padding: 20px 0 40px 0;">
        	<div class="deanftl"></div>
            <div class="deanftm">
            	<div class="ftmt">
                	<ul>
                    	<li><a href="#">公司简介</a> - &nbsp; </li>
                ...
                <p style="width:510px; height:26px; line-height:26px; display:block; font-size:12px; margin:0 auto; overflow:hidden;">版权所有：安吉市天亿广告传媒有限公司 投诉受理：0000-10101010 合作热线：100000000000</p>
                <p style="width:570px; height:26px; line-height:26px; display:block; font-size:12px; margin:0 auto; overflow:hidden;">备案信息：<a href="#">苏经营性ICP B2-20090218号</a> <a href="#">皖ICP备09697823号</a> 电子公告服务许可文件号:<a href="#">皖通[2009]556号</a></p>
                <p style="width:435px; height:26px; line-height:26px; display:block; font-size:12px; margin:0 auto; overflow:hidden;">Powered by <strong><a href="http://huyouxiong.com" target="_blank">忽悠兄</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://huyouxiong.com" target="_blank">Licensed</a><?php } ?>&nbsp;Tamplate By <a href="huyouxiong.com">迪恩网络</a>&nbsp;&nbsp;&copy; 2001-2013 <a href="http://huyouxiong.com" target="_blank">忽悠兄</a></p>
                <p style="width:410px; height:26px; line-height:26px; display:block; font-size:12px; margin:0 auto; overflow:hidden;">法律顾问：北京市菰盛（安吉）律师事务所王大力律师 电话：13817998655</p>
                <ul class="ft" style=" width:560px; margin:0 auto;margin-top:15px; overflow:hidden;">
                	<li><a href="#"><img src="<?php echo $_G['style']['styleimgdir'];?>/foot_gangting.gif" /></a></li>
                    <li><a href="#"><img src="<?php echo $_G['style']['styleimgdir'];?>/foot_beian.gif"/></a></li>
                    <li><a href="#"><img src="<?php echo $_G['style']['styleimgdir'];?>/foot_dzyy.gif"/></a></li>
                    <li><a href="#"><img src="<?php echo $_G['style']['styleimgdir'];?>/foot_baidu.gif"/></a></li>
                   
                    <div class="clear"></div>
                </ul>
            </div>
            <div class="deanftr"></div>
        </div>
    </div>
