...
0
|| checktplrefresh('data/diy/./template/dean_delight//forum/viewthread.htm', './template/dean_delight/forum/viewthread_node.htm', 1477893350, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_delight/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_delight//forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1477893350, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_delight/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_delight//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1477893350, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_delight/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_delight//forum/viewthread.htm', './template/default/common/seditor.htm', 1477893350, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_delight/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_delight//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1477893350, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_delight/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_delight//forum/viewthread.htm', './template/default/common/upload.htm', 1477893350, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_delight/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_delight//forum/viewthread.htm', './template/default/common/seccheck.htm', 1477893350, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_delight/', 'forum/viewthread')
;
block_get('223,225,227,226,224,228');?><?php include template('common/header'); ?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frameBSrf5B" class="cl_frame_bm frame move-span cl frame-1"><div id="frameBSrf5B_left" class="column frame-1-c"><div id="frameBSrf5B_left_temp" class="move-span temp"></div><?php block_display('223');?></div></div></div><!--[/diy]-->
</div>
    ...
    <div class="deangbt">
    	<div class="deangbtc">
             ...
             <div class="deangbtbox">
             	<ul><!--[diy=deangbtboxul]--><div id="deangbtboxul" class="area"><div id="frameag5Gl7" class="cl_frame_bm frame move-span cl frame-1"><div id="frameag5Gl7_left" class="column frame-1-c"><div id="frameag5Gl7_left_temp" class="move-span temp"></div><?php block_display('225');?></div></div></div><!--[/diy]--><div class="clear"></div></ul>
                <dl><!--[diy=deangbtboxdl]--><div id="deangbtboxdl" class="area"><div id="frameIY5td5" class="cl_frame_bm frame move-span cl frame-1"><div id="frameIY5td5_left" class="column frame-1-c"><div id="frameIY5td5_left_temp" class="move-span temp"></div><?php block_display('227');?></div></div></div><!--[/diy]--></dl>
                <ul><!--[diy=deangbtboxul1]--><div id="deangbtboxul1" class="area"><div id="framezJqqlx" class="cl_frame_bm frame move-span cl frame-1"><div id="framezJqqlx_left" class="column frame-1-c"><div id="framezJqqlx_left_temp" class="move-span temp"></div><?php block_display('226');?></div></div></div><!--[/diy]--><div class="clear"></div></ul>
                <div class="clear"></div>
             </div>
        </div>
    </div>
    ...
    <div  id="deanside">
    	<div class="deanbuttona">
        	<div class="deanbuttonac">
                ...
                <a id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖">发布主题</a>
                <?php } ?>
    	...
    	<div class="clear"></div>
       	<div class="deanhotlist">
        	<div class="deanhotlistc">
             	...
             	<div class="clear"></div>
                 <ul><!--[diy=deanhotlistc]--><div id="deanhotlistc" class="area"><div id="framew35Fnd" class="cl_frame_bm frame move-span cl frame-1"><div id="framew35Fnd_left" class="column frame-1-c"><div id="framew35Fnd_left_temp" class="move-span temp"></div><?php block_display('224');?></div></div></div><!--[/diy]--></ul>
             </div>
        </div>
    	<div class="clear"></div>
        <div class="deanpicbox">
            <div class="deanpics">
                <div class="deanh3"><span></span><em><strong>热门</strong>图文</em><div class="clear"></div></div>
                <div class="clear"></div>
                <ul><!--[diy=deanpics]--><div id="deanpics" class="area"><div id="frameLDGQul" class="cl_frame_bm frame move-span cl frame-1"><div id="frameLDGQul_left" class="column frame-1-c"><div id="frameLDGQul_left_temp" class="move-span temp"></div><?php block_display('228');?></div></div></div><!--[/diy]--></ul>
            </div>
        </div>
    	<div class="clear"></div>
    </div>
