...
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//forum/viewthread.htm', './template/comiis_meizhou/forum/viewthread_node.htm', 1477894790, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/comiis_meizhou/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/comiis_meizhou//forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1477894790, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/comiis_meizhou/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/comiis_meizhou//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1477894790, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/comiis_meizhou/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/comiis_meizhou//forum/viewthread.htm', './template/default/common/seditor.htm', 1477894790, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/comiis_meizhou/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/comiis_meizhou//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1477894790, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/comiis_meizhou/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/comiis_meizhou//forum/viewthread.htm', './template/default/common/upload.htm', 1477894790, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/comiis_meizhou/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/comiis_meizhou//forum/viewthread.htm', './template/default/common/seccheck.htm', 1477894790, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/comiis_meizhou/', 'forum/viewthread')
;
block_get('443,444');?><?php include template('common/header'); ?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<style id="diy_style" type="text/css">#frameC3vpad { border:0px none !important;margin:0px !important;}#portal_block_443 { border:0px none !important;margin:0px !important;}#portal_block_443 .dxb_bc { margin:0px !important;}#frameXp030A { border:0px none !important;margin:0px !important;}#portal_block_444 { border:0px none !important;margin:0px !important;}#portal_block_444 .dxb_bc { margin:0px !important;}</style>
...
<!--[diy=comiis_19dxc01]--><div id="comiis_19dxc01" class="area"><div id="frameC3vpad" class=" frame move-span cl frame-1"><div id="frameC3vpad_left" class="column frame-1-c"><div id="frameC3vpad_left_temp" class="move-span temp"></div><?php block_display('443');?></div></div></div><!--[/diy]-->
</div>
<div class="comiis_boxtwo cl">
<div class="comiis_alinkone">
 <!--[diy=comiis_19dxc03]--><div id="comiis_19dxc03" class="area"><div id="frameXp030A" class=" frame move-span cl frame-1"><div id="frameXp030A_left" class="column frame-1-c"><div id="frameXp030A_left_temp" class="move-span temp"></div><?php block_display('444');?></div></div></div><!--[/diy]-->
</div>
</div>
